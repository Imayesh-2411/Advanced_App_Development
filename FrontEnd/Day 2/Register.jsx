  ...
  return (
    <div className="signin-over">
        ...
        <form className='signin-frm'>
           ...
           <Link to="/AdHome"><button className='signin-but'>Register</button></Link>
            
            
            <h4 className='signin-h4tag'>Have an Account?  <Link to="/"><div className='signin-reg'>Sigin</div></Link></h4>
        </form>
    </div>
  );
  };
